...
<div class="container">
	...
	{% for event in site.data.events.2017-fall %}

	<div class="row row-talk previous-talks">

	<div class="col-sm-3 text-sm-left text-lg-right">
...
<div class="row">
	<h2>Spring 2017</h2>
		...
		<div class="col-sm-4 col-md-4 col-lg-3">
			<img src="images/duvall-poster-sm.jpg" width="100%" class="talk-poster">
		</div>
		</div>
